...
class Alipay {
    ...
    **/
    public function buildForm($request){
        $parameter = array(
            ...
            "anti_phishing_key" => $request['anti_phishing_key'],
            "exter_invoke_ip"   => $request['exter_invoke_ip'],
    ...
    **/
	public function buildWapForm($request)
    {
        ...
        . '</notify_url><call_back_url>' . $this->call_back_url 
        . '</call_back_url><seller_account_name>' . $this->seller_email 
        . '</seller_account_name><out_trade_no>' . $request["out_trade_no"]
        . '</out_trade_no><subject>' . $request["subject"]
        . '</subject><total_fee>' . $request["total_fee"]
        . '</total_fee><merchant_url>' . $this->merchant_url 
