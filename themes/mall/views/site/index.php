        ...
        <div id="myCarousel" class="carousel slide">
            ...
            <div class="carousel-inner">
                <div class="active item">
                    <img src="<?php echo Yii::app()->baseUrl ?>/upload/banner/1.jpg"/>
                </div>
                <div class="item">
                    <img src="<?php echo Yii::app()->baseUrl ?>/upload/banner/2.jpg"/>
                </div>
                <div class="item">
                    <img src="<?php echo Yii::app()->baseUrl ?>/upload/banner/3.jpg"/>
                </div>
            </div>
...
<div class="row">
    <div class="span12">
        ...
        <div class="row-fluid">
            <ul class="thumbnails">
                ...
                <li class="span2">
                    <a class="thumbnail" href="#">
                        <img alt="160x120" data-src="holder.js/260x120" style="width: 160px; height: 120px;" src="data:image/png;base64,">
                    </a>
                </li>
                <li class="span2">
                    <a class="thumbnail" href="#">
    ...
    <div class="span12">
        <div  style="border-bottom: 2px solid #2D89EF ;margin-bottom: 5px">
            <h5>服务流程<a  href="#" class="pull-right">more</a></h5>
        </div>
        <div class="row-fluid">
            <ul class="thumbnails">
                <li class="span3">
                    <a class="thumbnail" href="#">
                        <img alt="260x180" data-src="holder.js/260x180" style="width: 260px; height: 180px;" src="data:image/png;base64,">
                    </a>
                </li>
                <li class="span3">
                    <a class="thumbnail" href="#">
    ...
    <div class="span12">
        <div  style="border-bottom: 2px solid #00A300;margin-bottom: 5px">
            <h5>我们的客户 <a  href="#" class="pull-right">more</a></h5>
        </div>
        <div class="row-fluid">
            <ul class="thumbnails">
                <li class="span2">
